      ...
      <section className="bg-gradient-to-b from-secondary/20 to-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Legal terms and conditions for using Relax.ng services
          </p>
...
We are **Relax.ng** ('**Company**', '**we**', '**us**', or '**our**'), a company registered in Nigeria at **Relax.ng  
Northern Nigeria**.

We operate the website [https://relaxhq.ng](https://relaxhq.ng) (the '**Site**'), the mobile application **Relax.ng** (the '**App**'), as well as any other related products and services that refer or link to these legal terms (the '**Legal Terms**') (collectively, the '**Services**').

**Relax.ng** is a lifestyle services platform that connects you to trusted home services including laundry pickup and delivery, professional home cleaning, and home essentials delivery in Northern Nigeria.

You can contact us by email at **hello@relax.ng**, or through our mobile application.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and **Relax.ng**, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. **IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.**

We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by **hello@relax.ng**, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.

The Services are intended for users who are at least **18 years of age**. All users must have the legal capacity to enter into service agreements. If you are under 18, you must have your parent or guardian read and agree to these Legal Terms prior to you using the Services.
...
5. [LIFESTYLE SERVICES](#lifestyle-services)
6. [SERVICE BOOKINGS AND PAYMENTS](#service-bookings-and-payments)
7. [SERVICE PROVIDER NETWORK](#service-provider-network)
...
If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: **hello@relax.ng**. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
...
## 5. LIFESTYLE SERVICES <a id="lifestyle-services"></a>

Relax.ng provides lifestyle and home services to customers in Northern Nigeria. Our services include:

- **Laundry Services**: Professional laundry pickup, cleaning, and delivery
- **Home Cleaning**: Professional home cleaning services by vetted providers
- **Home Essentials**: Delivery of household items and daily necessities
- **Cultural Sensitivity**: Services that respect Halal requirements and prayer times
- **Quality Assurance**: Vetted and trained service providers

Eligibility for services requires:
- Valid contact information and delivery address in our service area
- Age of 18 or older (or parental consent)
- Acceptance of our service terms and provider matching process
- Payment method for service bookings

We reserve the right to modify, suspend, or discontinue any of these services at any time for any reason, including operational requirements or business decisions.

## 6. SERVICE BOOKINGS AND PAYMENTS <a id="service-bookings-and-payments"></a>

### Service Bookings

Relax.ng facilitates service bookings between customers and vetted service providers. By using our booking services, you agree to:

- Provide accurate and complete service requirements and delivery information
- Be available at the scheduled service time or provide appropriate access
- Pay applicable service fees as determined by our pricing structure
- Treat service providers with respect and professionalism

### Payment Processing

- **Service Payments**: Payments are processed securely through our payment partners
- **Booking Confirmation**: Services are confirmed upon successful payment processing
- **Cancellation Policy**: Cancellations may be subject to fees depending on timing and service type
- **Refunds**: Refunds for unsatisfactory service are handled according to our quality guarantee policy
...
All transactions are processed in Nigerian Naira (NGN) and are subject to applicable payment processing regulations and our internal policies.

## 7. SERVICE PROVIDER NETWORK <a id="service-provider-network"></a>

### Provider Vetting Process

Relax.ng maintains a network of vetted service providers who undergo our comprehensive screening process, which includes:

- **Background Checks**: Verification of identity and background
- **Skills Assessment**: Evaluation of service capabilities and experience
- **Cultural Training**: Training on cultural sensitivity, including Halal requirements and prayer times
- **Quality Standards**: Commitment to our service quality and professionalism standards

### Service Provider Matching

For service delivery, we match customers with appropriate providers based on:

- **Service Type**: Matching providers with relevant skills and experience
- **Location**: Providers available in your service area
- **Cultural Requirements**: Providers trained to meet specific cultural and religious needs
- **Availability**: Provider availability for your requested service time

### Quality Assurance

- Provider performance is continuously monitored through customer feedback
- Regular training and quality assessments are conducted
- Providers who fail to meet our standards may be removed from the network
- Customer satisfaction is our primary measure of service quality

You agree that service provider assignments are made at our discretion based on availability and suitability. We strive to match you with the best available provider for your specific needs.
...
- Provide false service information or attempt to bypass service provider vetting processes.
- Use the Services for fraudulent bookings or other illegal activities.
- Attempt to book services without valid payment methods or with intent to avoid payment.
- Share account credentials or allow unauthorized access to your Relax.ng account.
- Discriminate against or mistreat service providers based on race, religion, gender, or other protected characteristics.
...
These Legal Terms shall be governed by and defined following the laws of Nigeria. Relax.ng and yourself irrevocably consent that the courts of Nigeria shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
...
If you have any questions or need assistance regarding our SMS communications, please email us at hello@relax.ng or contact us through our mobile application.
